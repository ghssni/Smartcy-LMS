...
type LearningProgressServiceClient interface {
	...
	ResetLessonMark(ctx context.Context, in *ResetLessonMarkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// *
	...
	ResetAllLessonMarks(ctx context.Context, in *ResetAllLessonMarksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// *
	...
	UpdateLastAccessed(ctx context.Context, in *UpdateLastAccessedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *learningProgressServiceClient) ResetLessonMark(ctx context.Context, in *ResetLessonMarkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *learningProgressServiceClient) ResetAllLessonMarks(ctx context.Context, in *ResetAllLessonMarksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *learningProgressServiceClient) UpdateLastAccessed(ctx context.Context, in *UpdateLastAccessedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type LearningProgressServiceServer interface {
	...
	// Resets the progress of a specific lesson, removing its completion status.
	// This essentially allows a user to restart or reattempt a lesson.
	ResetLessonMark(context.Context, *ResetLessonMarkRequest) (*emptypb.Empty, error)
	// *
	// Resets all lesson marks for a specific enrollment.
	// This operation removes the completion status of all lessons for a specific enrollment ID.
	ResetAllLessonMarks(context.Context, *ResetAllLessonMarksRequest) (*emptypb.Empty, error)
	// *
	// Retrieves the total number of lessons completed for a specific enrollment.
	// This is useful for tracking the learner's progress within a course.
	...
	// Updates the last accessed timestamp for a lesson.
	// This is used to track when a user revisits a completed lesson.
	UpdateLastAccessed(context.Context, *UpdateLastAccessedRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedLearningProgressServiceServer) ResetLessonMark(context.Context, *ResetLessonMarkRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetLessonMark not implemented")
}
func (UnimplementedLearningProgressServiceServer) ResetAllLessonMarks(context.Context, *ResetAllLessonMarksRequest) (*emptypb.Empty, error) {
...
func (UnimplementedLearningProgressServiceServer) UpdateLastAccessed(context.Context, *UpdateLastAccessedRequest) (*emptypb.Empty, error) {
