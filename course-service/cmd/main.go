...
func main() {
	...
	reviewServer := service.NewReviewService()
	progressServer := service.NewLearningProgressService()
	...
	pb.RegisterLearningProgressServiceServer(grpcServer, progressServer)
